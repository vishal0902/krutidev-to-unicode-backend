// var begin = 0; // 0 if starting with kruti dev, 1 if starting with unicode
// var legacy_text_var = 'i`"BHkwfe'; // in Kruti Dev



function convert_to_unicode(krutidev_text) {
    
    var legacy_text_var = krutidev_text;
    ...
    //Corrections for Spelling mistakes (see above under he first Array):
    // "sas","aa","ZZ","=kk","f=k",
    //
...
module.exports = convert_to_unicode
